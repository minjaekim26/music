...
const SECTIONS = [
  ...
  {
    title: "통합 검색",
    body: "검색창 하나로 곡·아티스트·키워드·취향 자연어를 모두 검색할 수 있습니다. 입력 내용에 따라 자동으로 해석됩니다.",
    tips: [
      "곡/아티스트: BTS, Radiohead, Dynamite",
      "키워드: dreamy, indie, chill (쉼표로 여러 개)",
      "취향 자연어: 밤에 혼자 듣기 좋은 몽환적인 노래 추천해줘",
    ],
  },
  {
    title: "Every Noise 장르 맵",
    body: "everynoise.com과 같은 스크롤형 장르 지도입니다. 장르를 클릭해 선택하고, »로 하위 장르를 탐색한 뒤 추천을 받을 수 있습니다. 여러 장르를 고르면 선택한 장르를 모두 포함한 곡만 추천합니다. 최대 10개까지 선택 가능합니다.",
  },
  {
    title: "키워드 · 취향 추천",
    body: "짧은 영문 태그(dreamy, indie)나 쉼표로 구분한 키워드는 추천 모드로 동작합니다. 긴 한국어 문장은 AI가 mood·genre·tempo를 분석해 추천합니다.",
    tips: [
      "키워드 1개 → 넓은 추천",
      "2~3개 → 점점 구체화",
      "예시: dreamy, indie, chill, 80s",
    ],
  },
  {
    title: "곡 상세 화면",
