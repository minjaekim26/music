...
export default function Hero() {
  return (
    <section className="animate-slide-up px-4 pb-8 pt-4 text-center md:pb-12 md:pt-8">
      <h1 className="font-display mx-auto max-w-xl break-words text-2xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-3xl md:text-4xl" style={{ lineHeight: 1.3 }}>
